...
export function FinancialHero() {
    return (
        <section className="w-full min-h-[80vh] xl:h-[80vh] bg-[#F3F4F6] p-4 md:p-6 lg:p-8 flex items-center justify-center">
            <div className="max-w-[95vw] w-full grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-6 h-auto xl:h-full items-stretch">
