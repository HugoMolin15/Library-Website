            ...
            <div className="w-full relative">
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-24">
                    ...
                    <div className="relative rounded-2xl md:rounded-3xl shadow-2xl bg-white p-2 md:p-4 border border-white/20 overflow-hidden">
                        <div className="aspect-[16/9] w-full bg-gray-100 rounded-xl md:rounded-2xl flex items-center justify-center relative overflow-hidden">
                            <img
                                src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2426&auto=format&fit=crop"
                                alt="Dashboard Placeholder"
                                className="w-full h-full object-cover grayscale opacity-50 transition-opacity duration-500"
                            />
                            <div className="absolute inset-0 flex items-center justify-center">
                                <span className="text-gray-400 font-medium tracking-widest uppercase text-sm">Preview Dashboard</span>
                            </div>
                        </div>
                    </div>
                </div>
