...
// --- Stylized Company Logo SVG Components ---
...
export default function Page() {
    return (
        <ComponentPage
            ...
            description="A dynamic and interactive hero section featuring icons that react to mouse movement and float gracefully in the background."
